...
|---------|-------------|--------|
| `bmd` | Better Markdown CLI — export/preview markdown | public release asset; Apple Silicon and macOS Sequoia or later |
| `barista` | Claude Code modular statusline | public source archive; requires Bash and `jq` |

## Requirements

- **bmd:** Apple Silicon (`arm64`) and macOS Sequoia or later.
